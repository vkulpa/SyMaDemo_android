...
#include <string.h>
    ...
    int sps::sps_parse()
    {
		...
		else if(bsp2.pic_order_cnt_type == 1)
		{
			...
			for(int i=0;i<sbsp1.num_ref_frames_in_pic_order_cnt_cycle;i++)
			{
...
int16_t  sps::getWidth()
{
	return (int16_t) bsp3.pic_width_in_mbs_minus1;
}
int16_t  sps::getHeight()
{
	return (int16_t) bsp3.pic_height_in_map_units_minus1;
}
